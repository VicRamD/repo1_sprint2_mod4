const SongCard = ({cover, alt, title}) => {
    return (
        <div className="bg-dark-secondary rounded-lg shadow-lg overflow-hidden max-w-80">
            ...
            <div className="p-4">
                <button className="bg-button-primary hover:bg-amber-400 active:bg-red-600 text-dark-secondary py-2 px-4 rounded-md w-full font-semibold transition-colors duration-300">
